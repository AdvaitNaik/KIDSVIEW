...
MODEL_ARCHITECTURE = 'models\model_CM.json'
MODEL_WEIGHTS = 'models\model_child_maltreatment_final.h5'
...
MODEL_ARCHITECTUREE = 'models\model_activity.json'
MODEL_WEIGHTSS = 'models\model_activity_final.h5'
...
model1 = 'models\pose_deploy_linevec_faster_4_stages.prototxt'
model2 = 'models\pose_iter_160000.caffemodel'
